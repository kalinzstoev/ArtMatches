...
PostsListController = RouteController.extend({
    ...
    data: function() {
        ...
        console.log ("post count is " + this.posts().count());
        return {
            isEmpty: isEmpty,
            posts: this.posts(),
...
Router.route('/user/:username', {name: 'userInfo'});
...
Router.onBeforeAction(requireLogin, {only: ['userProfile','postSubmit', 'visualPostSubmit', 'audioPostSubmit', 'writtenPostSubmit']});
