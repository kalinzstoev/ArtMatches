...
Posts.deny({
    update: function(userId, post, fieldNames) {
        ...
        return (_.without(fieldNames, 'title','description', 'category', 'tags', 'type', 'text', 'content', 'filesIdArray', 'isContentPresent').length > 0);
    }
});
...
validateFilePost = function (post) {
    ...
    if (!post.isContentPresent)
        errors.isContentPresent = "Please upload at least one file";
